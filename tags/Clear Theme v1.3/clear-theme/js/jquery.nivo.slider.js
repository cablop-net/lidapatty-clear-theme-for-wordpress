    ...
    var NivoSlider = function(element, options){
		...
		var nivoRun = function(slider, kids, settings, nudge){
			...
			if(settings.effect != 'fade' && vars.randAnim != 'fade'){
				$('#slider-inner-wrapper').animate({ opacity:'1.0' }, (settings.animSpeed*2), '', function(){ slider.trigger('nivo:animFinished'); });
			}
			...
			if(settings.effect == 'sliceDown' || settings.effect == 'sliceDownRight' || vars.randAnim == 'sliceDownRight' ||
				...
				$('#slider-inner-wrapper').add(firstSlice).animate({ opacity:'1.0' }, (settings.animSpeed*2), '', function(){ slider.trigger('nivo:animFinished'); });
			}    
