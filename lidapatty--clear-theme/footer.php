		...
		<div class="wrapper">
			<div id="footer">
				<a href="<?php echo home_url( '/' ); ?>">
					<img src="<?php echo get_template_directory_uri(); ?>/images/logo-footer.png" alt="Invent" />
				</a>
<?php
								if( get_option('invent-socials-position')=='footer' || get_option('invent-socials-position')=='both' ) {
